package com.nadir.weather.controller;

import com.nadir.weather.controller.validation.CityNameConstraint;
import com.nadir.weather.dto.WeatherDto;
import com.nadir.weather.service.WeatherService;
...
@Validated
@Tag(name = "Open Weather API", description = "Open Weather API for filter by city")
